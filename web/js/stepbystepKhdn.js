...
function setCategorySbs(val) {
    var requestUrl = '/khdn.php/ajax/setCategorySbs';
    $.post(
        requestUrl,
        {val:val },
        function (data) {
...
function setAnswerSbs(val, question, checkChange) {
    var requestUrl = '/khdn.php/ajax/setAnswerSbs';
    var val = val.value;
    $.post(
        requestUrl,
...
function saveReviewQuestion(status, questionID) {
    var requestUrl = '/khdn.php/ajax/saveReviewQuestion';
    $.post(
        requestUrl,
...
function btChangeQA(question, answer, val) {
    var requestUrl = '/khdn.php/ajax/btChangeQA';
    $.post(
        requestUrl,
