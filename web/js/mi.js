...
function showTopCaoThu(){
    //$("#homeTopTaps div").removeClass("tabl").removeClass("overflow").addClass("tabl-inactive");
    //$("#homeTopTaps div a").removeClass("tabr-active").addClass("tabr-inactive");
    //$("#tabCaoThu").removeClass("tabl-inactive").addClass("tabl").addClass("overflow");
    //$("#tabCaoThu a").removeClass("tabr-inactive").addClass("tabr-active");
    //$(".userTop").hide();
...
function showTopDaiGia(){
    //$("#homeTopTaps div").removeClass("tabl").removeClass("overflow").addClass("tabl-inactive");
    //$("#homeTopTaps div a").removeClass("tabr-active").addClass("tabr-inactive");
    //$("#tabDaiGia").removeClass("tabl-inactive").addClass("tabl").addClass("overflow");
    //$("#tabDaiGia a").removeClass("tabr-inactive").addClass("tabr-active");
    //$(".userTop").hide();
...
function showTopVip(){
    //$("#homeTopTaps div").removeClass("tabl").removeClass("overflow").addClass("tabl-inactive");
    //$("#homeTopTaps div a").removeClass("tabr-active").addClass("tabr-inactive");
    //$("#tabVip").removeClass("tabl-inactive").addClass("tabl").addClass("overflow");
    //$("#tabVip a").removeClass("tabr-inactive").addClass("tabr-active");
    //$(".userTop").hide();
    //$("#topVip").show();
    $("#tabCaoThu").addClass("hidden")
