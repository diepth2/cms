...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'E:\\Projects\\new game\\CMS\\gamebai\\log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'E:\\Projects\\new game\\CMS\\gamebai\\cache\\backend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'E:\\Projects\\new game\\CMS\\gamebai\\apps\\backend/i18n',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'myPDOSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony-backend-vtp2'),
'database' => $this->getDatabaseManager()->getDatabase('doctrine'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'symfony-backend-vtp2',
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'E:\\Projects\\new game\\CMS\\gamebai\\cache\\backend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'E:\\Projects\\new game\\CMS\\gamebai\\apps\\backend/template',
)));
