...
require_once(dirname(__FILE__).'/../lib/BaseVtHomePageGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseVtHomePageGeneratorHelper.class.php');

/**
 * vtHomePage actions.
 *
 * @package    ##PROJECT_NAME##
 * @subpackage vtHomePage
 * @author     ##AUTHOR_NAME##
 * @version    SVN: $Id: actions.class.php 31002 2010-09-27 12:04:07Z Kris.Wallsmith $
 */
abstract class autoVtHomePageActions extends sfActions
{
  /**
  ...
  {
    $this->configuration = new vtHomePageGeneratorConfiguration();
    ...
    $this->helper = new vtHomePageGeneratorHelper();
  ...
  {
    return $this->getUser()->getAttribute('vtHomePage.filters', $this->configuration->getFilterDefaults(), 'admin_module');
  }

  protected function setFilters(array $filters)
  {
    return $this->getUser()->setAttribute('vtHomePage.filters', $filters, 'admin_module');
  }
  ...
  {
    $this->getUser()->setAttribute('vtHomePage.max_per_page', (integer) $max_per_page, 'admin_module');
  }
  
  protected function getMaxPerPage()
  {
    return $this->getUser()->getAttribute('vtHomePage.max_per_page', sfConfig::get('app_default_max_per_page', 20), 'admin_module');
  }

  protected function setPage($page)
  {
    $this->getUser()->setAttribute('vtHomePage.page', $page, 'admin_module');
  }

  protected function getPage()
  {
    return $this->getUser()->getAttribute('vtHomePage.page', 1, 'admin_module');
  }
  ...
  {
    if (null !== $sort = $this->getUser()->getAttribute('vtHomePage.sort', null, 'admin_module'))
    {
      return $sort;
    }
    ...
    return $this->getUser()->getAttribute('vtHomePage.sort', null, 'admin_module');
  }
  ...
  protected function setSort(array $sort)
  {
    ...
    $this->getUser()->setAttribute('vtHomePage.sort', $sort, 'admin_module');
  }
