...
/**
 * CmsCategoryFooter filter form base class.
 *
 * @package    Vt_Portals
 * @subpackage filter
 * @author     diepth2
 ...
 */
abstract class BaseCmsCategoryFooterFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cms_category_footer_filters[%s]');
